...
public:
    ...
    public:
         ...
         */
        Asteroid(const Vec2 p, const Vec2 v);
         ...
         */
        Asteroid(const Vec2 p, const Vec2 v, int type);
...
public:
     ...
     */
    void spawnAsteroid(Vec2 p, Vec2 v, int type=3);
     ...
     */
    void draw(const std::shared_ptr<SpriteBatch>& batch, Size size);
};
