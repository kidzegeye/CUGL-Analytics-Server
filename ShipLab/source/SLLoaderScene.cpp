 ...
 */
bool LoaderScene::init(const std::shared_ptr<AssetManager>& assets) {
 ...
 */
void LoaderScene::update(float progress) {
    if (_progress < 1) {
 ...
 */
bool LoaderScene::isPending( ) const {
