...
#pragma mark Constructors
     ...
     */
    Ship(const Vec2& pos, std::shared_ptr<JsonValue> data);
...
#pragma mark Properties
     ...
     */
    void setPosition(Vec2 value) { _pos = value; }
     ...
     */
    void setPosition(Vec2 value, Vec2 size);
     ...
     */
    void setVelocity(Vec2 value) { _vel = value; }
    ...
    /**
     * Returns the current refire counter.
     *
     * @return the current refire value.
     */
    int getRefire() const { return _refire; }

    /**
     * Sets the current refire counter.
     *
     * @param value The current refire value.
     */
    void setRefire(int value){ _refire=value; }
...
#pragma mark Movement
     ...
     * @param size      The size of the window (for wrap around)
     */
    void move(float forward, float turn, Size size);
