...
#pragma mark Asset Loading
     ...
     * Those textures will be materialized the same time the OBJ mesh is
     * materialized.
     *
     ...
     */
    void materialize(const std::string key, const std::shared_ptr<ObjModel>& model,
...
#pragma mark Constructors
     ...
     */
    ObjLoader() : Loader<ObjModel>() { _jsonKey = "objs"; _priority = 1; }
